...
const CreateRecipePage   = lazy(() => import('@/components/pages/CreateRecipePage'))
const IngredientSearch   = lazy(() => import('@/components/pages/IngredientSearchPage'))
    ...
    <Suspense fallback={<PageLoader />}>
      <Routes>
        ...
        <Route element={<MainLayout />}>
          ...
          {/* Privadas */}
          <Route path="receita/nova" element={
